...
mkdir fpga
svn co https://github.com/sindhu023/FWC/tree/main/fpga/blink
cd codes
...
The code below realizes the Boolean logic for Z   using 5V,GND of Vaman Board using Verilog Language
\begin{center}
\fbox{\parbox{8.5cm}{\url{https://github.com/sindhu023/FWC/blob/main/fpga/blink/helloworldfpga.v}}}
\end{center}
\end{document}