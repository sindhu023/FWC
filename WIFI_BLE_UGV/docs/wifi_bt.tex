...
\begin{lstlisting}
# To copy repository
svn co https://https://github.com/sindhu023/FWC/tree/main/WIFI_BLE_UGV
cd WIFI_BLE_UGV
...
\item Esp32 is connected to mobile using hotspot.Now connect Esp32 to WifiToyCar using IP Address.Now the display is controlled using WifiToyCar application.
