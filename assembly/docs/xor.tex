...
\vspace{2cm}
\title{ 
XOR logic through AVR-Assembly 
}
...
\begin{abstract}
This manual shows how to implement XOR logic through AVR-Assembly.
\end{abstract}
...
3. connect the 7447 BCD Decoder to Arduino using table 3.\\
4. Verify the XOR operation in assembly using the following code and making
pin connections according to fig 1,Table 2 and 3.
