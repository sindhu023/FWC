...
\begin{abstract}
This manual shows how to implement XOR logic through AVR-GCC.
\end{abstract}
...
\end{figure}
%\begin{table}[!h]
%4.The inputs of 7447 BCD Decoder is connected to Arduino using below Table 3.
%\centering
%\input{7447_ard.tex}
%\caption{}
...
3. connect pin A of 7447 to D2 of Arduino and connect remaining pins B,C and D to GND.\\
4. connect pins 8,9 of Arduino to Vcc(high) and change to GND(low) simultaneously.\\
5. Verify the XOR operation in AVR-GCC using the following code and making
pin connections according to fig 2,3 and Table 2.
